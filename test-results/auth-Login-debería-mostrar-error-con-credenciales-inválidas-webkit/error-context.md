...
- Name: auth.spec.ts >> Login >> debería mostrar error con credenciales inválidas
- Location: tests\e2e\auth.spec.ts:144:7
      ...
      - generic [ref=e17]:
        ...
        - generic [ref=e18]:
          - textbox "Contraseña" [ref=e19]:
            - /placeholder: ••••••••
            - text: wrongpassword
          - button "Mostrar contraseña" [ref=e20]:
            - img [ref=e21]
      - button "Iniciar Sesión" [ref=e24]
    - generic [ref=e25]:
      - link "¿Olvidaste tu contraseña?" [ref=e26]:
        - /url: /forgot-password
      - paragraph [ref=e27]:
        - text: ¿No tenés cuenta?
        - link "Crear cuenta" [ref=e28]:
          - /url: /register
