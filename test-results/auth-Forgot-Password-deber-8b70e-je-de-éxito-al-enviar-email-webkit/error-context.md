...
- Name: auth.spec.ts >> Forgot Password >> debería mostrar mensaje de éxito al enviar email
- Location: tests\e2e\auth.spec.ts:215:7
...
- generic [ref=e1]:
  - generic [ref=e3]:
    ...
    - generic [ref=e12]:
      ...
      - button "Enviar Enlace" [active] [ref=e16]
    - link "Volver al inicio de sesión" [ref=e18]:
      - /url: /login
